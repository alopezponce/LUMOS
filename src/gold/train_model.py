...
# 1. Cargar entorno y silenciar warnings ANTES de importar TensorFlow
load_dotenv()
...
def train_solar_model():
    ...
    print("aracterísticas y Limpieza...")
    ...
    print("Entrenando red neuronal LSTM (Split 80/20)...")
    ...
    # APLICADO EL SPLIT 0.2 (20% Validación)
    model.fit(X_rnn, y, epochs=40, batch_size=16, verbose=0, validation_split=0.2)

    print("Guardando el modelo y el escalador...")
    ...
    print(f"Entrenamiento completado. R² score: {r2:.4f}")
